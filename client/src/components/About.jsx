...
function About() {
  ...
  const aboutText = {
    ...
    values: `
      <div>
        Integrity - We behave ethically and are respectful, open, and honest in our business and personal lives.<br />
        Quality Engineering - We provide high-quality engineering to meet client needs.<br />
        Client Satisfaction - We engage our clients and the communities we serve so that they know us, trust, and value our services.<br />
        Technical Innovation - We develop better engineering solutions through research and development.<br />
